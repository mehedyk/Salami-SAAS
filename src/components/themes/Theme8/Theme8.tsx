...
import styles from "./Theme8.module.css";
import { getTheme8Cursor } from "./Theme8.cursor";
...
export default function Theme8({ eidType, recipientName, customMessage, phone, duas }: Theme8Props) {
  const [currentDuaIndex, setCurrentDuaIndex] = useState(0);
  const cursorEffect = getTheme8Cursor();
