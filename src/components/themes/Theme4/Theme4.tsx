...
import styles from "./Theme4.module.css";
import { getTheme4Cursor } from "./Theme4.cursor";
...
export default function Theme4({ eidType, recipientName, customMessage, phone, duas }: Theme4Props) {
  const [currentDuaIndex, setCurrentDuaIndex] = useState(0);
  const cursorEffect = getTheme4Cursor();
