...
import styles from "./Theme10.module.css";
import { getTheme10Cursor } from "./Theme10.cursor";
...
export default function Theme10({ eidType, recipientName, customMessage, phone, duas }: Theme10Props) {
  const [currentDuaIndex, setCurrentDuaIndex] = useState(0);
  const cursorEffect = getTheme10Cursor();
