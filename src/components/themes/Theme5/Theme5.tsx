...
import styles from "./Theme5.module.css";
import { getTheme5Cursor } from "./Theme5.cursor";
...
export default function Theme5({ eidType, recipientName, customMessage, phone, duas }: Theme5Props) {
  const [currentDuaIndex, setCurrentDuaIndex] = useState(0);
  const cursorEffect = getTheme5Cursor();
