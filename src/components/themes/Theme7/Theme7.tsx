...
import styles from "./Theme7.module.css";
import { getTheme7Cursor } from "./Theme7.cursor";
...
export default function Theme7({ eidType, recipientName, customMessage, phone, duas }: Theme7Props) {
  const [currentDuaIndex, setCurrentDuaIndex] = useState(0);
  const cursorEffect = getTheme7Cursor();
