...
import styles from "./Theme9.module.css";
import { getTheme9Cursor } from "./Theme9.cursor";
import { Dua } from "@/lib/duas";

interface Theme9Props {
  eidType: string;
...
export default function Theme9({ eidType, recipientName, customMessage, phone, duas }: Theme9Props) {
  const [currentDuaIndex, setCurrentDuaIndex] = useState(0);
  const cursorEffect = getTheme9Cursor();
